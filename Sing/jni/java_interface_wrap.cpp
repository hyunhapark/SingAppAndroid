...
SWIGEXPORT void JNICALL Java_com_rameon_sing_opensl_SingModuleJNI_stop_1base_1process(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
  stop_base_process();
}
...
SWIGEXPORT void JNICALL Java_com_rameon_sing_opensl_SingModuleJNI_start_1inst_1process(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
  start_inst_process();
}
...
SWIGEXPORT void JNICALL Java_com_rameon_sing_opensl_SingModuleJNI_stop_1inst_1process(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
  stop_inst_process();
}
...
SWIGEXPORT jint JNICALL Java_com_rameon_sing_opensl_SingModuleJNI_inst_1load(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int)inst_load();
  jresult = (jint)result; 
  return jresult;
}
