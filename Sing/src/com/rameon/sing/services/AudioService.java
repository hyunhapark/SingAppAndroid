...
package com.rameon.sing.services;
...
import com.rameon.sing.audio.AudioDeviceManager;
import com.rameon.sing.audio.HeadsetManager;
import com.rameon.sing.audio.HeadsetManagerListener;
import com.rameon.sing.audio.HeadsetMode;
import com.rameon.sing.io.AudioDevice;
import com.rameon.sing.threads.AudioThread;
	...
	HeadsetManagerListener, OnSharedPreferenceChangeListener
{
	...
	public void startThread()
	{
        ...
        {
        	new Utils(this).toast("가급적 헤드셋이나 이어폰을 사용해 주십시오.");
//            if (listener != null)
//            {
